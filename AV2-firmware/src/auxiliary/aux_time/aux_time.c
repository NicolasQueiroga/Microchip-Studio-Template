...
_Bool get_rtc_second_flag(void) { return flag_rtc_second; }
void set_rtc_second_flag(_Bool val) { flag_rtc_second = val; }

volatile _Bool flag_rtc_alarm = 0;
_Bool get_rtc_alarm_flag(void) { return flag_rtc_alarm; }
